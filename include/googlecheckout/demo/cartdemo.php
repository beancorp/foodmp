...
//   UseCase3();
  ...
  function Usecase() {
      ...
      $merchant_id = "265686485532977";  // Your Merchant ID
      $merchant_key = "aLyZLX_R6Hj65Hhhh6o5RQ";  // Your Merchant Key
      $server_type = "sandbox";
      $currency = "AUD";
      ...
      $cart->SetEditCartUrl("http://dev.infinitytech.cn/php/googlecheckout/demo/cartdemo.php");
      
      // Specify "Return to xyz" link
      $cart->SetContinueShoppingUrl("http://dev.infinitytech.cn/php/googlecheckout/demo/cartdemo.php");
...
//     echo "</pre>";
  ...
  function UseCase3() {
    ...
    $cart->SetMerchantCalculations(
        "https://www.sienpo.com/googlecheckout/demo/responsehandlerdemo.php", // merchant-calculations-url
