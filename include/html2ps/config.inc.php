...
define('WHITESPACE_FONT_SIZE_FRACTION', 0);
...
define('PAGE_BREAK_INSIDE_AVOID_PENALTY',  5000);
define('PAGE_BREAK_AFTER_AVOID_PENALTY',  400);
define('PAGE_BREAK_BEFORE_AVOID_PENALTY', 400);
define('PAGE_BREAK_ORPHANS_PENALTY',      2);
define('PAGE_BREAK_WIDOWS_PENALTY',       2);
define('PAGE_BREAK_LINE_PENALTY',            1);
