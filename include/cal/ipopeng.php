...
<title>PopCalendarXP 9.7.289 Lite Edition - Copyright 2003-2006 Idemfactor Solutions, Inc.</title>
...
var gd=new Date(), gToday=[<?php echo date("Y");?>,<?php echo date("m");?>,<?php echo date("d");?>];
...
function varDate() {
	...
	alert("Missing or invalid license for PopCalendarXP!\nPlease make sure the license file is in the right place.");
