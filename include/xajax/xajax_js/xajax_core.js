...
xajax.loadingFunction = function(){try{getElementById('loadingMessage').style.display='block'; }catch(ex){}}; 
xajax.doneLoadingFunction = function(){getElementById('loadingMessage').style.display = 'none';}
