...
$fan_promotion_content = $socObj->displayPageFromCMS(129);
$smarty->assign('fan_promotion_content', $fan_promotion_content['aboutPage']);


$smarty->assign('pageTitle','Fan Promotion');
$sidebarContent = '
...
$content = $smarty->fetch('fan_promotion.tpl');
