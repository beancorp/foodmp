...
$html = file_get_contents(SOC_HTTP_HOST.'foodwine/shoponline_print.php?StoreID='.$_SESSION['StoreID'].'&print=0&s=c427b395ea2bab03cbd4a82d153ed778'.(isset($_GET['subAttrib']) ? '&subAttrib='.$_GET['subAttrib'] : ''));
$file	= 'upload/pdf/'.$_SESSION['StoreID'].'_shoponline.pdf';
