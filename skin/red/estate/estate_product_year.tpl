...
{/if}
<fieldset id="uploadproduct" style="width:455px;">
...
<fieldset id="bulkupload" style="width:100%;">
     <table style="width:100%;" cellspacing="0" cellpadding="0" align="left">
		 ...
		 <tr>
		 <td align="right" style="padding-right:10px;"><input name="image" type="image" class="submit" onclick="document.mainForm.op.value='next'; if (continueNextStep()) document.mainForm.submit(); void(0);" value="Continue to Next Step" src="/skin/red/images/bu-next.gif" />
