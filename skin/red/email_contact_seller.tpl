...
<p>This is a Food Marketplace email alert. Please check-in to your <a href="{$req.webside_link}">Food Marketplace</a> admin area. You have an email waiting for you.</p>
...
{elseif $req.display eq 'consubscriber_detail'}
...
<tr>
	<td>Website Name:</td>
	<td><a href="{$req.webside_link}">{$req.seller_nickname}</a></td>
</tr>
<tr>
	<td>Name:</td>
	<td>{$req.fromName}</td>
...
<p> Dear {$req.buyer_nickname}, </p>
<p>This is a message from FoodMarketplace website: <a href="{$req.webside_link}">{$req.seller_nickname}</a></p>
...
{elseif $req.display eq 'contbuyer'}
