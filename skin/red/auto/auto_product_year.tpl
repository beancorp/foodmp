...
<p align="center" class="txt" style="padding-top:0; margin-top:0; margin-bottom:25px;">
	<a href="/auto/?act=product&cp=pay&feetype=year&step=4" title="Pay Fee" style="color:red;">
    Click here to pay $120 for one year with unlimited listing for your account.
    </a>
</p>
{elseif 0}
<p align="center" class="txt" style="padding-top:0; margin-top:0; margin-bottom:25px;">
	<a href="/auto/?act=product&cp=renew&feetype=year&step=4" title="Renew Fee" style="color:red;">
    Your account will be expired on {$req.info.product_renewal_date|date_format:"$PBDateFormat"}. If you want to list your cars after <br />
    this day, please click here to renew for your account. 
    </a>
</p>
{/if}
...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td>
	<select name="carType" class="inputB" id="sector_1" onchange="{$req.element.jsSector}" style="width:287px;" >
  ...
  <tr>
    ...
    <td>
	<select name="make" class="inputB" id="sector_2" onchange="{$req.element.jsSector};check_make2(this.value);" style="width:287px;">
  ...
  <tr>
    ...
    <td>
	<select name="model" id="sector_3" class="inputB" style="width:287px;" onchange="check_model2(this.value);">
  ...
  <tr>
    ...
    <td>
	<select name="year" id="year" class="inputB" style="width:112px">
...
<fieldset id="bulkupload">
     <table style="width:100%;">
		 ...
		 <tr>
		 <td colspan="2" align="right"><input class="submit" type="image" src="/skin/red/images/bu-next.gif" value="Continue to Next Step" onclick="document.mainForm.op.value='next'; if (continueNextStep()) document.mainForm.submit(); void(0);" />
