...
{literal}
<style type="text/css">
span#main_swf_upload_uploading .uploadcancel,span#mainImage1_swf_upload_uploading .uploadcancel,span#mainImage2_swf_upload_uploading .uploadcancel{ border:0; margin-right:15px;}
...
$(function() {
		$("#main_swf_upload").makeAsyncUploader({
			upload_url: soc_http_host+"uploadproduct_img.php?objImage=mainImage0&tpltype=3&attrib=0&index=0",
		...
		$("#mainImage1_swf_upload").makeAsyncUploader({
			upload_url: soc_http_host+"uploadproduct_img.php?objImage=mainImage1&tpltype=3&attrib=1&index=0",
            flash_url: '/skin/red/js/swfupload.swf',
            button_image_url: '/skin/red/images/blankButton.png',
            disableDuringUpload: 'INPUT[type="submit"]',
           	file_types:'*.jpg;*.gif;*.png',
...
<div id="disauto-a">
	...
	<div style="float:left; width:300px;">A feature image can be
	...
	<tr>
	<td>
	<a id="main_swf_upload" href="javascript:uploadImage(3, 0, 0, 'mainImage0' );void(0);"><img src="/skin/red/images/bu-uploadimages-sm.gif" border="0" align="absmiddle" /></a>
	...
	<td colspan="2" align="left" valign="middle" height="50">
		<a href="javascript:deleteImage(3, 0, 0, 'mainImage0' );void(0);"><img src="/skin/red/images/bu-delete-sm.jpg" alt="Delete" title="Delete" align="absmiddle" /></a>	</td>
	</tr>
	</table>
	</div>
	
	<div style="float:right; margin-right:10px;">
	<img id="uploadimages" src="/skin/red/auto/images/auto-a-blank.jpg" alt="" />
	</div>
</div>
...
<div id="disauto-b">
	...
	<tr>
	<td>
	<a id="mainImage1_swf_upload" href="javascript:uploadImage(3, 1, 0, 'mainImage1' );void(0);"><img src="/skin/red/images/bu-uploadimages-sm.gif" border="0" align="absmiddle" /></a>	
	...
	<tr>
      <td colspan="2" align="left" valign="top">For perfect fit, the image size is 750 x 100 pixels</td>
	  </tr>
	<tr>
		<td colspan="2" align="left" valign="top">
	...
	<tr>
	<td colspan="2" align="left" valign="middle" height="50">
		<a href="javascript:deleteImage(3, 1, 0, 'mainImage1' );void(0);"><img src="/skin/red/images/bu-delete-sm.jpg" alt="Delete" title="Delete" align="absmiddle" /></a>	</td>
	</tr>
	</table>
	</div>
	
	<div style="float:right; margin-right:10px;">
	<img id="uploadimages" src="/skin/red/auto/images/auto-b-blank.jpg" alt="" />
	</div>
</div>
