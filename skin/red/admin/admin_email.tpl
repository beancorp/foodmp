...
{else}
	...
	<ul id="table" style="width:720px;">
	<li class="tabletop" style="width:600px;">{$lang.email.lb_storename}</li>
	<li class="tabletop" style="width:100px;">{$lang.email.lb_mailids}</li>
	{if $req.list.list}
	{foreach from=$req.list.list item=l}
	<li style="width:600px;">{$l.bu_name}</li>
	<li style="width:100px;"><a href="#" onclick="javascript:xajax_StoreWiseEmailReportListShow('{$l.storeid}');">{$l.records}</a></li>
