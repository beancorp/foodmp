{literal}
<style type="text/css">
	ul.mainlist {list-style:none; margin:0; width:629px; background:#9E99C1; float:left; }
	...
	ul.listhead li.detail{width:192px;}
...
<div align="center">
<div id="refcontent" style="width:629px;">
{include file="wishlist/wishlist_emaillist.tpl"}
</div>
</div>
