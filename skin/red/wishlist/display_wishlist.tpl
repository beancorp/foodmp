...
<div id="wishlist_content" style="background:URL({$wishinfo.template}) no-repeat; float:left; width:750px; ">
	<div id="wishlist_left">
        ...
        <object width="243" height="160">
            <param name="movie" value="{$wishproinfo.youtubevideo}"></param>
            <param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param>
            <embed src="{$wishproinfo.youtubevideo}" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="243" height="160"></embed>
         </object>
        </div>
    	{/if}
        <div id="wishInfoleft" style=" margin:0;width:100%;">
            ...
            <div id="moredetails" style="background:url(/skin/red/images/wishlist_left/{$wishinfo.subCat}_mid.png) repeat-y;"><div id="detail_inner" style="color:{$wishinfo.subColor}">{$wishproinfo.description|strip_tags|nl2br}</div>
            </div>
    ...
    <div id="wishlist_center">
    	<div id="wishlist_header" style="background:{$wishproinfo.color};position:relative;">
         <table cellpadding="0" cellspacing="0">
            ...
            </tr></table><a style="color:#FFFFFF;font-size:11px; top:5px;padding-left:15px;position:absolute;right:10px;background:transparent url(/skin/red/images/arrow-purple.gif) no-repeat scroll 0 1px;text-decoration:none;" href="javascript:history.go(-1);">Back</a></div>
 ...
 <table width="100%" cellspacing="0"><tr><td align="left" style="padding-left:10px;">(Total items: {$procount|number_format:0})</td>
            	<td><span style="padding-right:20px;">{$req.product.pagination}{$req.product.0.linkStr}</span></td></tr></table></div>
    </div><img src="/skin/red/images/wish_bottom.png"/></div>
    <div style="clear:both;"></div>
