        ...
        <div id="head-main-menu">
            {if not $race_page}
                ...
                <div id="navigation_links">					
                    ...
                    <div class="navigation_link" style="margin-left: 7px;">
                    ...
                    <div class="navigation_link" style="float: left; margin-left: 7px;">
                    ...
                    <div class="social-icon" style="float: left; margin-left: 7px; margin-top: -2px;">
                        ...
                        <a target="_blank" href="https://twitter.com/foodmarketplace" style="text-decoration:none;"><img src="{$smarty.const.SOC_HTTP_HOST}skin/red/images/icon-twitter.png" style="margin-left: 5px; cursor: pointer;" alt=""> </a>
