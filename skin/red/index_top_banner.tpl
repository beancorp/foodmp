		...
		<div id="head-main-menu">
			{if not $race_page}
				<div id="navigation_links">
                    ...
                    <div class="social-icon" style="float: left; margin-left: 10px; margin-top: -2px;">
                        ...
                        <a href="https://twitter.com/foodmarketplace" style="text-decoration:none;"><img src="./skin/red/images/icon-twitter.png" style="margin-left: 9px; cursor: pointer;" alt=""> </a>
                        <a href="http://instagram.com/foodmarketplaceofficial" style="text-decoration:none;"><img src="./skin/red/images/icon-instagram.png" style="margin-left: 5px; cursor: pointer;" alt=""></a> 
                    </div>
				</div>
