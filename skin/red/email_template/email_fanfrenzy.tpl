    ...
    <td >
         <table width="839" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="139" style="background-color:#4f467b;">
                    <a href="{if $smarty.const.LANGCODE eq 'en_au'}http://foodmarketplace.com.au{else}http://foodmarketplace.com{/if}" style="text-decoration: none;color: grey;font-weight: bold;">{if $smarty.const.LANGCODE eq 'en_au'}foodmarketplace.com.au{else}foodmarketplace.com{/if}</a>
                </td>
