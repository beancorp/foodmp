...
<div class="category-list">
    <ul id="category_ul">
    	{if $categories}
    	{foreach from=$categories item=c key=k}
    	<li onmouseover="mouseEventLI(this, true);" onmouseout="mouseEventLI(this, false);" id="cat_li_{$k}">
        	<label>Category {php} echo ++$k;{/php}</label>
            <input type="text" value="" size="30" class="text" name="category_name[]" />
            <input type="hidden" value="{$c.id}" size="30" class="text" name="cid[]" />
            <a href="javascript:void(0);" onclick="delCategory('{$k}', '{$c.id}');" class="category-oper-del">Delete</a>
...
<div style="padding-bottom:40px; position:relative">
    ...
    <a style="float:right; position:absolute; right:100px;" onclick="return checkForm('sendorder');" href="javascript:void(0);"><img src="/skin/red/images/foodwine/save-categories.png"></a>
    </div>
<div class="clear"></div>
<div style="border-bottom:1px solid #CCCCCC; margin:0 0 10px;"></div>
<h2 class="product-edit-h2">{if foodwine_type eq 'food'}Specify Items{else}Specify Menu Items{/if}</h2>
<form action="" name="mainForm" method="POST" id="uploadsomething" onsubmit="return checkForm(document.getElementById('uploadsomething'));" style="height:560px; border-top:none; padding:0;">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="4">
    ...
    <tr>
      ...
      <td valign="top"><input type="radio" name="type" value="stock" checked="checked" onclick="changeType(this)">
        &nbsp;<strong style="font-weight:bold;">Stock Product</strong>
    ...
    <tr id="quantityline" style="">
      <td align="right">Stock Quantity </td>
      <td style="line-height:22px; width:295px; color:red; vertical-align:middle;"><input name="stockQuantity" type="text" class="price" style="border:1px red solid;" id="stockQuantity" size="30" value="{$productInfo.stock_quantity|escape}" />
...
<a name="list"><p>&nbsp;</p><p>&nbsp;</p>
<form action="/foodwine/index.php?act=product&cp=delete" method="post" onsubmit="" id="multform" />
...
<table cellpadding="0" cellspacing="0" width="98%" id="myproducts" class="sortable" style="">
  ...
  <thead>
    <tr>
      <td colspan="10"><div style="background-color: rgb(238, 238, 238); width:200px; height: 40px; margin: 0pt 0px; border-bottom: 1px solid rgb(238, 238, 238);">
          <ul class="tabtmp">
...
<table cellpadding="0" cellspacing="0" width="98%" style="margin-top:10px;">
  ...
  <tr>
    <td></td>
    <td align="right"><input type="button" name="multAct" onclick="multcheckform();" value="Delete"/>
