...
{/literal}
<div style="margin:0">
<h1 class="soc-flyers">Your Flyers</h1>
<div class="oper-emailalerts">
	<input type="button" onclick="window.open('{$smarty.const.SOC_HTTP_HOST}flyer_pdf.php{if $req.info.subAttrib}?subAttrib={$req.info.subAttrib}{/if}','_blank','width=790,height=560,toolbar=0,scrollbars=yes,location=0,statusbar=0,menubar=0,resizable=1');void(0);" style="cursor:pointer;padding:3px;margin:3px;" value="Create PDF / Print Flyer">
</div>
<div class="clear"></div>
<div style="position:relative; width:748px; margin-bottom: 10px;">
	<img width="748" height="527" src="/flyer_images/visit_us/{$req.info.subAttrib}.jpg" />
