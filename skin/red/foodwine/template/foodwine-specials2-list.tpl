...
<div class="sellerhome_items_list" style="position:relative;">
	...
	<div style=" position:relative; float:left; width:350px; left: 15px; z-index: 100; top: -4px;"><fb:like href="{$smarty.const.SOC_HTTP_HOST}foodwine/index.php?act=product&cp=list&type=special&StoreID={$req.info.StoreID}" send="false" width="auto" show_faces="false" font="arial" style="padding-top:5px;"></fb:like></div>
	<div class="clear"></div>
