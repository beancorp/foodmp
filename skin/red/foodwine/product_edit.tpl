...
<div style="padding-bottom:40px; position:relative">
    ...
    <a style="float:right; position:absolute; right:70px;" onclick="return checkCategoryForm();" href="javascript:void(0);"><img src="/skin/red/images/foodwine/save-categories.png"></a>
    </div>
</form>
<div class="clear"></div>
<div style="border-bottom:1px solid #CCCCCC; margin:0 0 10px;"></div>
...
<form style="height:600px; border-top:none; padding:0;" action="" name="mainForm" method="POST" id="uploadsomething" onsubmit="return checkForm(document.getElementById('uploadsomething'));">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="4"> 
    ...
    {else}
    <tr>
      <td align="right" class="field">Special Item</td>
    ...
    <tr id="noauction" style="display:{if $req.select.is_auction == 'yes'}none{else}{/if}">
      <td align="right" valign="top" style="vertical-align:top; padding-top:8px;" class="field">Price<span id="required_price" style=" display:{if $productInfo.is_special || (!$productInfo.pid && $foodwine_type=='wine') || $productInfo.type eq 'special' || $req.info.sold_status}inline{else}none{/if}">*</span></td>
    ...
    <td>
                ...
                <p style="margin:0; padding-left:5px; font-family:Arial; font-size:16px; font-weight:bold; color:red; width:255px">Click after you update every item</p>
                <br />
    </td>
    </tr>
  </table>
...
<table cellpadding="0" cellspacing="0" width="98%" id="myproducts" class="sortable" style="">
  ...
  <tr>
    ...
    <td><img src="{if !empty($p.small_image)}{$p.small_image}{else}/images/243x212.jpg{/if}" width="61" height="35" /></td>
    ...
    <td><strong>{if $p.price neq '0.00'}${$p.price}{/if}</strong></td>
    ...
    <td><ul id="icons-products" style="margin:0 0 0 15px;">
        ...
        <li><a href="javascript:deletes('/foodwine/index.php?act=product&cp=delete&pid[]={$p.pid}');void(0);" title="{$lang.but.delete}"><img src="/skin/red/images/icon-deletes.gif" /></a></li>
