...
<tr><td align="center">
  <table width="645" cellspacing="0" bgcolor="#f5f5f5" cellpadding="0" border="0">
    ...
    <tr>
      ...
      <td colspan="2" valign="top">
        <table width="639" cellspacing="0" cellpadding="0" border="0">
          <tbody>
          <tr>
        <td valign="top" height="149" bgcolor="#FFFFFF">
              ...
              <tr>
                <td valign="middle" height="20" colspan="2">
                  <table cellspacing="0" cellpadding="0" border="0" width="360">
                    ...
                    <tr>
                      <td width="15"></td>
                      <td width="25" align="left"><font style="font-style:normal;font:12px arial,sans-serif;color:#585858; font-weight:bold;">Date:</font>&nbsp;&nbsp;<font style="font-style:normal;font:12px arial,sans-serif;color:#585858;">{$req.order_date|date_format:"%d/%m/%Y %H:%M"}</font></td>
                    ...
                    <tr height="25">
                      <td width="15"></td>
                      <td width="100" colspan="2" align="left"><font style="font-style:normal;font:12px arial,sans-serif;color:#585858; font-weight:bold;">Billing Information</font></td>
                    </tr>
                    <tr height="20">
                      <td width="15"></td>
                      <td width="100" colspan="2" align="left"><font style="font-style:normal;font:12px arial,sans-serif;color:#585858;">{$req.bu_name}</font></td>
                    </tr>
                    <tr height="20">
                      <td width="15"></td>
                      <td width="100" colspan="2" align="left"><font style="font-style:normal;font:12px arial,sans-serif;color:#585858;">{$req.bu_address}</font></td>
                    </tr>
                    <tr height="20">
                      <td width="15"></td>
                      <td width="100" colspan="2" align="left"><font style="font-style:normal;font:12px arial,sans-serif;color:#585858;">{$req.bu_suburb}, {$req.bu_state}  {$req.bu_postcode}</font></td>
                    </tr>
                  </tbody>
                  </table>
                </td>
    ...
    <tr>
      <td bgcolor="{$req.bgcolor}">&nbsp;</td>
      <td valign="top" bgcolor="#ffffff" width="100%" align="center" colspan="2">
