...
<div style="border: none; position: relative; width: 710px; font: arial,sans-serif;">
	<img width="710" src="{$smarty.const.SOC_HTTP_HOST}/flyer_images/fan_promotion/{$req.info.subAttrib}.jpg" />
	...
	<div style="position:absolute; padding: 10px; border: 2px solid #878787; font-size: 24px; font-family: arial; font-weight: bold; color:#000; {$position_url}">
		{$req.info.bu_urlstring|lower}.foodmp.com.au <img src="{$smarty.const.SOC_HTTP_HOST}/flyer_images/cursor.gif" height="40px" style="position: absolute; bottom: -20px; right: -15px;" />
	</div>
</div>
</div>
<div style="margin: 10px;">
