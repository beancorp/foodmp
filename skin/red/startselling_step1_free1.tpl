...
<table width="720" border="0" cellpadding="0" cellspacing="4" id="table14">
	<tr>
     ...
     <tr>
     <td style="padding:5px 0 5px 90px;color:#F26521" colspan="2" align="center">{$lang.labelSelectMarketPlace}</td>
     <td>&nbsp;</td>
     </tr>
	...
	<tr id="tr_username" style="display:{if $req.attribute neq "5"}none{/if}">
		<td align="right" valign="top"><span class="txt" style="height:25px; line-height:25px;"><span class="lbl" style="color:#F26521">{$lang.labelUsername}*</span></span></td>
		...
		{else}
			<span style="color:#F26521">{$req.bu_username}</span>
	...
	<tr style="display:{if $req.attribute neq "5" || $isUpdate}none{/if}" id="tr_username_tip">
	  ...
	  <td colspan="2"><span style="color: #F26521">Unique to each user/store across the site.<br />Usernames cannot be changed once created.</span></td>
	  </tr>
	<tr>
		<td align="right" valign="top"><span class="txt" style="height:25px; line-height:25px;"><span class="lbl" style="color:#F26521">{$lang.labelEmail}*</span></span></td>
		<td colspan="2"><span class="style11"><font face="Verdana" size="1">
		{if $isUpdate == false}
		...
		{else}
			<span style="color:#F26521">{$req.bu_user}</span>
	...
	{if $isUpdate == false}
    <tr>
		<td align="right"><span class="txt"><span class="lbl" style="color:#F26521">Re-enter {$lang.labelEmail}*</span></span></td>
		<td colspan="2">
	...
	<tr>
	  ...
	  <td colspan="2"><span style="color: #F26521">Cannot be changed</span></td>
	  </tr>
	  {/if}
	  <tr>
	...
	<tr>
		<td align="right"><span class="txt"><span class="lbl" id="tnk" style="color:#F26521">
		{if $req.attribute=='0' && 0}
        {$lang.labelContactPerson}*
        {else}
        {$lang.labelNickName}*
        {/if}</span></span></td>
		<td colspan="2"><span class="style11"><font face="Verdana" size="1">{if $isUpdate == false}<input name="bu_nickname" type="text" class="inputB" id="bu_nickname" value="{$req.bu_nickname}" size="30" />{else}<span style="color:#F26521">{$req.bu_nickname}</span><input name="bu_nickname" type="hidden" class="inputB" id="bu_nickname" value="{$req.bu_nickname}" size="30" />{/if}</font></span></td>
	</tr>
	
	{if $isUpdate == false}
	<tr>
      <td align="right" height="20">&nbsp;</td>
	  <td colspan="2"><span style="color: #F26521">This will be visible to others on the website and cannot be changed!</span></td>
	  </tr>
	{/if}
	<tr>
	...
	<tr valign="top">
		<td align="right" valign="middle"><span class="txt"><span class="lbl">{$lang.labelAddress}*<font color="#F26521"></font></span></span></td>
...
{if false}	
	<tr id="trprocode" {if $req.StoreID neq ""}style="display:none"{/if}>
...
{elseif $req.ref_name neq ''}
		...
		<tr id="referid">
      <td align="right"><span class="txt"><span class="lbl" style="color:#F26521">{$lang.labelreferrer} </span></span></td>
	  <td colspan="2"><span class="style11"><font face="Verdana" size="1">		
		<span class="lbl" style="color:#F26521">{$req.ref_name}</span><input name="referrer" type="hidden" class="inputB" id="referrer" value="{$req.referrer}" size="30" />
      </font></span></td>
	</tr>

{/if}	
	<tr id="referrer_tips" style="display:none">
      <td align="right"><span class="txt"><span class="lbl" style="color:#F26521"></span></span></td>
...
<div id="" style="margin-top:17px;">
	...
	<img id="reg_img_0" style="display:{if $req.attribute neq '0' && $req.attribute neq ''}none{/if}" src="/skin/red/images/register_banner/buynow_signup.jpg" border="0" usemap="#mapms" title="Sell everything online For $10 a year rate"  alt="Sell everything online For $10 a year rate"/>
	<img id="reg_img_1" style="display:{if $req.attribute neq '1'}none{/if}" src="/skin/red/images/register_banner/estate_signup.jpg" border="0" usemap="#mapms" title="Sell everything online For $10 a year rate"  alt="Sell everything online For $10 a year rate"/>
	<img id="reg_img_2" style="display:{if $req.attribute neq '2'}none{/if}" src="/skin/red/images/register_banner/auto_signup.jpg" border="0" usemap="#mapms" title="Sell everything online For $10 a year rate"  alt="Sell everything online For $10 a year rate"/>
	<img id="reg_img_3" style="display:{if $req.attribute neq '3'}none{/if}" src="/skin/red/images/register_banner/career_signup.jpg" border="0" usemap="#mapms" title="Sell everything online For $10 a year rate"  alt="Sell everything online For $10 a year rate"/>
	<img id="reg_img_5" style="display:{if $req.attribute neq '5'}none{/if}" src="/skin/red/images/register_banner/foodwine_signup.jpg" border="0" usemap="#mapms" title="Sell everything online For $10 a year rate"  alt="Sell everything online For $10 a year rate"/>
...
<input type="hidden" name="item_name" value="Deposit money in your account">
	...
	{/if}
	<div id="payDivContainer" style="padding:0px; margin:0px;">
	<!--<img id="payDivContainer_image1" src="/skin/red/images/step1_top.jpg"  style="padding:0px; margin:0px;"/>-->
    <div id="payDivContainer_content" style="padding:10px; height:100px; background:none" align="center">
		<!--<div style="width:450px; margin-bottom:10px; font-size:14px; line-height: 150%;">
		...
		<input src="/skin/red/images/buttons/btn-start-listing.png" class="submit form-continuepayment" type="image" onclick="paymentSubmitSet(); document.mainForm.cp.value='payment';" title="Start Listing">
		</fieldset>
	</div>	
	...
	<div style="padding: 0px; margin: 0px 0px 0px 30px; width: 488px;" id="payDivContainer1">
	<img style="padding: 0px; margin: 0px;" src="/skin/red/images/step1_top.jpg" id="payDivContainer_image1"><div align="center" style="padding: 10px; height: 110px; background: none repeat scroll 0% 0% rgb(241, 241, 241);" id="payDivContainer_content">
		<!--<div id="payOptions1" style="width:450px; margin-bottom:10px; font-size:14px; line-height: 150%; display:block;">
			<font style="font-weight:normal;font-size:18px;">Open your website now for </font><font style="font-size:26px;color:#F26521">just <b style="font-size:26px;color:#F26521;font-weight:bold;">$10</b> per year</font><br /><font style="font-size:18px;">that's <font style="color:#3D2F84;font-size:18px;"><font style="font-weight:bold;font-size:18px;color:#3D2F84;">83 cents</font> per month</font> or only<font style="color:#3D2F84;font-size:18px;"> <font style="font-weight:bold;font-size:18px;color:#3D2F84;">2.7 cents</font> per day!</font></font>
		</div>-->
		...
		<div style="width: 450px; margin-bottom: 10px; font-size: 14px; line-height: 150%;" id="payOptions6">
			<font style="font-weight:normal;font-size:18px;">Open your website now for </font><font style="font-size:26px;color:#F26521">just <b style="font-size:26px;color:#F26521;font-weight:bold;">$120</b> per year</font><br><font style="font-size:18px;">that's <font style="color:#3D2F84;font-size:18px;"><font style="font-weight:bold;font-size:18px;color:#3D2F84;">1000 cents</font> per month</font> or only<font style="color:#3D2F84;font-size:18px;"> <font style="font-weight:bold;font-size:18px;color:#3D2F84;">32.8 cents</font> per day!</font></font>
		</div>
        <div class="clear"></div>
...
<fieldset style="text-align:left; padding-left:158px; padding-top:20px;">
	{if $isUpdate == true}
		{if $userlevel eq 1}
		<input src="{if $smarty.session.attribute == 0}/skin/red/images/buyseller_step_button/edit_store_details.gif{else}/skin/red/images/bu-continue.gif{/if}" class="submit form-save" type="image" {if $isUpdate == false}disabled{/if} onclick="document.mainForm.cp.value='next';">
