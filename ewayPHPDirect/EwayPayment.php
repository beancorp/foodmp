...
class EwayPayment {
	...
	/*
        ...
        $xml->addChild('ewayCustomerID', htmlentities( $this->myCustomerID ) );
        $xml->addChild('ewayTotalAmount', htmlentities( $this->myTotalAmount) );
        $xml->addChild('ewayCardHoldersName', str_replace('&', '&amp;', htmlentities( $this->myCardHoldersName ) ) );
        $xml->addChild('ewayCardNumber', htmlentities( $this->myCardNumber ) );
        $xml->addChild('ewayCardExpiryMonth', htmlentities( $this->myCardExpiryMonth ) );
        $xml->addChild('ewayCardExpiryYear', htmlentities( $this->myCardExpiryYear ) );
        $xml->addChild('ewayTrxnNumber', '');
        $xml->addChild('ewayCustomerInvoiceDescription', '' );
        $xml->addChild('ewayCustomerFirstName', '' );
        $xml->addChild('ewayCustomerLastName', '' );
        $xml->addChild('ewayCustomerEmail', str_replace('&', '&amp;', trim(htmlentities( $this->myCustomerEmail ) ) ) );
        $xml->addChild('ewayCustomerAddress', str_replace('&', '&amp;', htmlentities( $this->myCustomerAddress ) ) );
        $xml->addChild('ewayCustomerPostcode', str_replace('&', '&amp;', trim(htmlentities( $this->myCustomerPostcode )) ) );
        $xml->addChild('ewayCustomerInvoiceRef', '');

        //if ($this->getUseccv()) {
            $xml->addChild('ewayCVN',  htmlentities( $this->myCVN ) );
        //}
