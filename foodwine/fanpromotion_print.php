...
if ($req['print'] == 0) {
	...
	switch ($req['info']['subAttrib']) {
		case 1:
			...
			$position_url = 'top: 230px; left: 60px;';
			break;
		case 2:
		...
		case 3:
			$position_logo = 'right: 20px; top: 20px;';
			$position_url = 'top: 230px; left: 110px;';
			break;
		case 4:
		...
		case 8:
			...
			$position_url = 'top: 165px; left: 200px;';
			break;
		case 9:
			$position_logo = 'right: 20px; top: 20px;';
			$position_url = 'top: 250px; left: 160px;';
			break;
		case 10:
			$position_logo = 'left: 20px; bottom: 150px;';
			$position_url = 'top: 200px; left: 55px;';
			break;
	}
...
if ($req['print']) {
	$smarty -> display('fanpromotion_print.tpl');
} else {
	$smarty -> display('fanpromotion_pdf.tpl');
}
