...
class MyFetcherMemory extends Fetcher {
	...
	function get_data($url) {
		if (!$url) {
			...
			return new FetchedDataURL(@fileGetContents($url), array(), "");
		}
	}
...
$path = SOC_HTTP_HOST.'foodwine/flyers_print.php?StoreID='.$_SESSION['StoreID'].'&print=0&s=c427b395ea2bab03cbd4a82d153ed778'.(isset($_GET['subAttrib']) ? '&subAttrib='.$_GET['subAttrib'] : '');
$html = fileGetContents($path);
$file = 'upload/pdf/'.$_SESSION['StoreID'].'_flyers.pdf';
