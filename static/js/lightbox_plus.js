...
LightBox.prototype = {
	...
	_show : function(num)
	{
		...
		imag.onload = function() {
			...
			self._box.style.zIndex	= "10000";
			self._box.style.border	= "3px solid #000099";
...
addEvent(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:'/images/gfx/loading.gif',
		expandimg:'/images/gfx/expand.gif',
		shrinkimg:'/images/gfx/shrink.gif',
		closeimg:'/images/gfx/close.gif'
	});
});
