...
(function($) {
    $.fn.makeAsyncUploader = function(options) {
        return this.each(function() {
            ...
            var id = $(this).attr("id");
            var container = $("<span class='asyncUploader' id='asyncUploader_" + id + "'/>");
            container.append($("<div id='pro_tab_bar_" + id + "'><div class='ProgressBar' id='ProgressBar_" + id + "'> <div>&nbsp;</div> </div><span id='" + id + "_uploading' class='class_uploadding'><input type='button' class='uploadcancel' value=''/></span><div style='clear:both'></div></div>"));
