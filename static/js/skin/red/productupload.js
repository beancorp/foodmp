...
$(function() {	
		$("#swf_upload_1").makeAsyncUploader({
				upload_url: soc_https_host+"uploadproduct_img.php?objImage=mainImage&tpltype="+protype+"&attrib=0&index=0",
				flash_url: soc_https_host + 'skin/red/js/swfupload.swf',
		...
		$("#swf_upload_2").makeAsyncUploader({
				upload_url: soc_https_host+"uploadproduct_img.php?objImage=subImage0&tpltype="+protype+"&attrib=1&index=0",
				flash_url: soc_https_host + 'skin/red/js/swfupload.swf',
		...
		$("#swf_upload_3").makeAsyncUploader({
				upload_url: soc_https_host+"uploadproduct_img.php?objImage=subImage1&tpltype="+protype+"&attrib=1&index=1",
				flash_url: soc_https_host + 'skin/red/js/swfupload.swf',
				button_image_url: '/skin/red/images/buttons/upload_samll.png',
				disableDuringUpload: 'INPUT[type="submit"]',
				file_types:'*.jpg;*.gif;*.png',
		...
		$("#swf_upload_4").makeAsyncUploader({
				upload_url: soc_https_host+"uploadproduct_img.php?objImage=subImage2&tpltype="+protype+"&attrib=1&index=2",
				flash_url: soc_https_host + 'skin/red/js/swfupload.swf',
				button_image_url: '/skin/red/images/buttons/upload_samll.png',
				disableDuringUpload: 'INPUT[type="submit"]',
				file_types:'*.jpg;*.gif;*.png',
		...
		$("#swf_upload_5").makeAsyncUploader({
				upload_url: soc_https_host+"uploadproduct_img.php?objImage=subImage3&tpltype="+protype+"&attrib=1&index=3",
				flash_url: soc_https_host + 'skin/red/js/swfupload.swf',
				button_image_url: '/skin/red/images/buttons/upload_samll.png',
				disableDuringUpload: 'INPUT[type="submit"]',
				file_types:'*.jpg;*.gif;*.png',
		...
		$("#swf_upload_6").makeAsyncUploader({
				upload_url: soc_https_host+"uploadproduct_img.php?objImage=subImage4&tpltype="+protype+"&attrib=1&index=4",
				flash_url: soc_https_host + 'skin/red/js/swfupload.swf',
				button_image_url: '/skin/red/images/buttons/upload_samll.png',
				disableDuringUpload: 'INPUT[type="submit"]',
				file_types:'*.jpg;*.gif;*.png',
		...
		$("#swf_upload_7").makeAsyncUploader({
				upload_url: soc_https_host+"uploadproduct_img.php?objImage=subImage5&tpltype="+protype+"&attrib=1&index=5",
				flash_url: soc_https_host + 'skin/red/js/swfupload.swf',
				button_image_url: '/skin/red/images/buttons/upload_samll.png',
				disableDuringUpload: 'INPUT[type="submit"]',
				file_types:'*.jpg;*.gif;*.png',
		...
		$("#swf_upload_8").makeAsyncUploader({
				upload_url: soc_https_host+"uploadproduct_img.php?objImage=planImage0&tpltype="+protype+"&attrib=2&index=0",
				flash_url: soc_https_host + 'skin/red/js/swfupload.swf',
				button_image_url: '/skin/red/images/buttons/upload_samll.png',
				disableDuringUpload: 'INPUT[type="submit"]',
				file_types:'*.jpg;*.gif;*.png',
		...
		$("#csv").makeAsyncUploader({
				upload_url: soc_http_host+"upload_bulkupload.php?type=csvmsg",
