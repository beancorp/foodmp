...
function HyperTextArea(name, html, width, height,resourcePath,styleSheetUrl,delayRender){
	...
	this._renderDefault = function(html){
		document.writeln('<textarea name="' + this.name + '" id="' + this.name + '" style="width: ' + this.width + 'px; height: ' + this.height + 'px; padding:2px 0 3px 5px; color:#000000; font:11px verdana; border:1px solid #3A9CCB; ">' + html + '</textarea>');
	}
